...
class OutputBlock(nn.Module):
    """Output block described in the paper"""
...
class NFNPlus(nn.Module):
    """ 
    UNet-like network with 2 stages and skip connections between stages, 
    as described in: https://www.sciencedirect.com/science/article/pii/S0893608020300721
    """
    ...
    def __init__(self, num_classes, in_channels, is_deep_supervision=True, p=0.2):
        ...
        # Standard 2x max pooling for downsampling
