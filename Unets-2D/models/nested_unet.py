...
class NestedUNet(nn.Module):
    """
    Nested UNet architecture as proposed in the UNet++ paper:
    ...
    def __init__(self, num_classes, in_channels, 
        ...
        assert l_num in [2, 3, 4], "Only 2, 3 or 4 levels implemented for UNet++"
        ...
        # Shared max pooling for downsampling
        self.downsampling = nn.MaxPool2d(kernel_size=2, stride=2)  
        
        # Shared bilinear interpolation for upsampling
        self.upsampling = nn.Upsample(scale_factor=2, mode='bilinear', align_corners=True) 
        
        # Encoding path convolutions
        ...
        # Deep supervision output convolutions
        ...
        # Remove unnecessary layers for shallower variants
        if self.l_num == 2:
